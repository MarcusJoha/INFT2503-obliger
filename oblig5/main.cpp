...
public:
    ...
    class King : public Piece {
        ...
        public:
            ...
            bool valid_move (int x_from, int y_from, int x_to, int y_to ) const {
                int abs_x_change = abs(x_from - x_to);
                int abs_y_change = abs(y_from - y_to);
    ...
    class Knight : public Piece {
        ...
        public:
            ...
            bool valid_move (int x_from, int y_from, int x_to, int y_to ) const {
                ...
                if (abs_x_change == 1 && abs_y_change == 2) return true;
                if (abs_x_change == 2 && abs_y_change == 1) return true;
